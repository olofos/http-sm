...
enum http_state
{
    ...
    //
    HTTP_STATE_READ_SERVER_METHOD       = 0x13,
    HTTP_STATE_READ_SERVER_PATH         = 0x14,
    HTTP_STATE_READ_SERVER_QUERY        = 0x15,
    HTTP_STATE_READ_SERVER_VERSION      = 0x16,
    //
    HTTP_STATE_READ_CLIENT_VERSION     = 0x17,
    HTTP_STATE_READ_CLIENT_STATUS      = 0x18,
    HTTP_STATE_READ_CLIENT_STATUS_DESC = 0x19,
    //
